...
// import
// com.scoutress.KaimuxAdminStats.repositories.playtime.AnnualPlaytimeRepository;
// import com.scoutress.KaimuxAdminStats.servicesImpl.DataExtractingServiceImpl;
// import
// com.scoutress.KaimuxAdminStats.servicesImpl.playtime.AnnualyPlaytimeServiceImpl;
...
// DailyPlaytime playtime1 = new DailyPlaytime(null, (short) 1, 1000.0,
// dateWithinLastYear, "Server1");
// DailyPlaytime playtime2 = new DailyPlaytime(null, (short) 1, 2000.0,
// dateWithinLastYear, "Server1");
// DailyPlaytime playtime3 = new DailyPlaytime(null, (short) 1, 1500.0,
// dateOlderThanOneYear, "Server1");

// List<DailyPlaytime> dailyPlaytimes = Arrays.asList(playtime1, playtime2,
// playtime3);

// // Call the method to test
// List<AnnualPlaytime> result =
// annualyPlaytimeService.calculateAnnualPlaytime(dailyPlaytimes);
...
// DailyPlaytime playtime1 = new DailyPlaytime(null, (short) 1, 1000.0,
// dateWithinLastYear, "Server1");
// DailyPlaytime playtime2 = new DailyPlaytime(null, (short) 2, 2000.0,
// dateWithinLastYear, "Server2");
