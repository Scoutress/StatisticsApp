...
// import
// com.scoutress.KaimuxAdminStats.Repositories.old.LoginLogoutTimesRepository;
// import
// com.scoutress.KaimuxAdminStats.Services.old.PlaytimeCalculationService;

// @Service
// public class PlaytimeCalculationServiceImpl implements
// PlaytimeCalculationService {
...
// List<LoginLogoutTimes> loginLogoutTimes =
// getEmployeeLoginLogoutTimes(employee);
// Map<String, Map<LocalDate, Double>> playtimePerServer =
// calculatePlaytimeForEmployee(loginLogoutTimes);
...
// private Map<String, Map<LocalDate, Double>>
// calculatePlaytimeForEmployee(List<LoginLogoutTimes> loginLogoutTimes) {
...
// private void updatePlaytimeForEmployee(Employee employee, Map<String,
// Map<LocalDate, Double>> playtimePerServer) {
// for (Map.Entry<String, Map<LocalDate, Double>> entry :
// playtimePerServer.entrySet()) {
...
// private void resetPlaytimeForServer(DailyPlaytime dailyPlaytime, String
// serverName) {
...
// private void updatePlaytimeForServer(DailyPlaytime dailyPlaytime, String
// serverName, Double playtime) {
