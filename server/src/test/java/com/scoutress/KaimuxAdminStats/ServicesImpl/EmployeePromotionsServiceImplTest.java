...
import com.scoutress.KaimuxAdminStats.Servicesimpl.EmployeePromotionsServiceImpl;
...
public class EmployeePromotionsServiceImplTest {
  ...
  public void testGetAllEmployeePromotionsWithEmployeeData_ReturnsData() {
    EmployeePromotionsPlus employeePromotion1 = new EmployeePromotionsPlus(
        1, "user1", "Level 1", LocalDate.of(2020, 1, 1), LocalDate.of(2021, 1, 1), LocalDate.of(2022, 1, 1),
        LocalDate.of(2023, 1, 1));
    EmployeePromotionsPlus employeePromotion2 = new EmployeePromotionsPlus(
        2, "user2", "Level 2", LocalDate.of(2019, 5, 15), LocalDate.of(2020, 6, 15), LocalDate.of(2021, 7, 15),
        LocalDate.of(2022, 8, 15));
    List<EmployeePromotionsPlus> expectedPromotions = Arrays.asList(employeePromotion1, employeePromotion2);
    ...
    assertEquals(LocalDate.of(2020, 1, 1), actualPromotions.get(0).getToSupport());

    verify(employeePromotionsRepository, times(1)).findAllEmployeePromotionsWithEmployeeData();
  }
