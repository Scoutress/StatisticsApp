...
// import
// com.scoutress.KaimuxAdminStats.Entity.old.DcTickets.DcTicketPercentage;
...
// import
// com.scoutress.KaimuxAdminStats.Repositories.old.DcTickets.DcTicketPercentageRepository;
// import
...
// DcTicketPercentageRepository dcTicketPercentageRepository, EmployeeRepository
// employeeRepository,
...
// EmployeePromotions promotions =
// employeePromotionsRepository.findByEmployeeId(employeeId);
// LocalDate supportDate = promotions != null ? promotions.getToSupport() :
// null;

// if (supportDate == null || joinDate == null) {
// System.out.println(
// "Employee with ID " + employeeId + " has no support promotion date or join
// date. Skipping.");
// continue;
// }
...
// System.out
// .println("Employee with ID " + employeeId + " has no valid tickets after
// filtering. Skipping.");
// continue;
// }
...
// productivityRepository.findByEmployeeId(employeeId);
...
// .filter(ticket -> {
// Employee employee =
// employeeRepository.findById(ticket.getEmployeeId()).orElse(null);
// if (employee == null) {
// return false;
// }
// LocalDate joinDate = employee.getJoinDate();
...
// List<DcTicketPercentage> allPercentages =
// dcTicketPercentageRepository.findAll();

// Map<Integer, List<DcTicketPercentage>> percentagesPerEmployee =
// allPercentages.stream()
// .collect(Collectors.groupingBy(DcTicketPercentage::getEmployeeId));

// for (Map.Entry<Integer, List<DcTicketPercentage>> entry :
// percentagesPerEmployee.entrySet()) {
// Integer employeeId = entry.getKey();
