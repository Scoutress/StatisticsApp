...
// import
// com.scoutress.KaimuxAdminStats.entity.playtime.AveragePlaytimeLastYear;
// import com.scoutress.KaimuxAdminStats.entity.playtime.DailyPlaytime;
// import
// com.scoutress.KaimuxAdminStats.repositories.playtime.AveragePlaytimeLastYearRepository;
// import com.scoutress.KaimuxAdminStats.servicesImpl.DataExtractingServiceImpl;
// import
// com.scoutress.KaimuxAdminStats.servicesImpl.playtime.AveragePlaytimeLastYearServiceImpl;
...
// new DailyPlaytime(2L, (short) 1, 120.0, LocalDate.now().minusDays(1),
// "note"));

// List<EmployeeCodes> employeeCodes = Arrays.asList(
// new EmployeeCodes(1L, (short) 1, (short) 0, (short) 0, (short) 0, (short) 0,
// (short) 0, (short) 0,
// (short) 0, (short) 0, (short) 0));

// List<Employee> employees = Arrays.asList(
// new Employee((short) 1, "John Doe", "Department", "Position", "Email",
// "Phone", LocalDate.now(), "helper"));
...
// // Act
// List<AveragePlaytimeLastYear> averagePlaytimes =
// service.calculateAveragePlaytime(dailyPlaytimes, employeeCodes,
// employees);
...
// List<AveragePlaytimeLastYear> averagePlaytimeList =
// Arrays.asList(averagePlaytime);
