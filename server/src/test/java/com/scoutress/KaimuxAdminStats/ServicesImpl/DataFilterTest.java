...
// List<SanitizedSessionData> result =
// dataFilterService.filterSanitizedSessionsByAid(dataList, (short) 10);
...
// List<SanitizedSessionData> adminSessions =
// dataFilterService.filterSanitizedSessionsByAid(dataList, (short) 10);
...
// new SanitizedSessionData((long) 5, (short) 10, time, true, "survival"),
// new SanitizedSessionData((long) 9, (short) 10, time, true, "skyblock"));
// List<SanitizedSessionData> actualLogins =
// dataFilterService.filterSanitizedSessionsByAction(adminSessions,
// true);
