...
@Entity
@Table(name = "playtime_data_all_creative")
public class PlaytimeDataAllCreative {
    ...
    public PlaytimeDataAllCreative(){}

    public PlaytimeDataAllCreative(Integer id, Integer itsVaidasOn, Integer itsVaidasOff, Integer itsVaidasDiff,
