...
// Complains complain1 = new Complains(1L, 101, LocalDate.of(2023, 8, 13),
// 25.5);
// Complains complain2 = new Complains(2L, 102, LocalDate.of(2023, 8, 14),
// 30.0);
...
// Complains complain2 = new Complains(2L, 102, LocalDate.of(2023, 8, 14),
// 30.0);
// Complains complain3 = new Complains(3L, 103, LocalDate.of(2023, 8, 15),
// 35.0);
// List<Complains> complainsList = Arrays.asList(complain1, complain2,
// complain3);
