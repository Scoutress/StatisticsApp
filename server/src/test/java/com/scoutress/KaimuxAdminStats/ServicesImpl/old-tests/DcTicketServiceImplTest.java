...
// import
// com.scoutress.KaimuxAdminStats.Repositories.DcTickets.DcTicketPercentageRepository;
// import
...
// EmployeePromotions promotions = new EmployeePromotions(1, 1, null, null,
// null, null);
...
// @Test
// public void
// updateDiscordTicketsAverage_ShouldSkipIfNoValidTicketsAfterFiltering() {
// DcTicket dcTicket = new DcTicket(1, LocalDate.now().minusDays(10), 5);
// Employee employee = new Employee();
// employee.setId(1);
// employee.setJoinDate(LocalDate.now().minusDays(20));

// EmployeePromotions promotions = new EmployeePromotions(1,
// LocalDate.now().minusDays(5), null, null, null);
...
// @Test
// public void
// updateDiscordTicketsAverage_ShouldSaveProductivityWhenValidTicketsExist() {
...
// Employee employee = new Employee(1, LocalDate.now().minusDays(20));
// EmployeePromotions promotions = new EmployeePromotions(1, 1,
// LocalDate.now().minusDays(15), null, null, null);

// when(dcTicketRepository.findAll()).thenReturn(Arrays.asList(dcTicket1,
// dcTicket2));
// when(employeeRepository.findById(1)).thenReturn(Optional.of(employee));
// when(employeePromotionsRepository.findByEmployeeId(1)).thenReturn(promotions);
...
// @Test
// public void
// calculateDcTicketsPercentage_ShouldSkipIfNoValidTicketsAfterFiltering() {
// DcTicket dcTicket = new DcTicket(1, LocalDate.now().minusDays(10), 5);
...
// verify(dcTicketPercentageRepository,
// never()).save(any(DcTicketPercentage.class));
// }

// @Test
// public void
// calculateDcTicketsPercentage_ShouldSavePercentageWhenValidTicketsExist() {
...
// verify(dcTicketPercentageRepository,
// times(1)).save(any(DcTicketPercentage.class));
// }

// @Test
// public void
// updateAverageDcTicketsPercentages_ShouldNotUpdateIfProductivityIsNull() {
// DcTicketPercentage percentage = new DcTicketPercentage(1, LocalDate.now(),
// 50.0);
...
// @Test
// public void
// updateAverageDcTicketsPercentages_ShouldUpdateProductivityWhenPercentagesExist()
// {
// DcTicketPercentage percentage = new DcTicketPercentage(1, LocalDate.now(),
// 50.0);
