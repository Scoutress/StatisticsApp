...
@Entity
@Table(name = "playtime_data_all_boxpvp")
public class PlaytimeDataAllBoxpvp {
    ...
    public PlaytimeDataAllBoxpvp(){}

    public PlaytimeDataAllBoxpvp(Integer id, Integer itsVaidasOn, Integer itsVaidasOff, Integer itsVaidasDiff,
