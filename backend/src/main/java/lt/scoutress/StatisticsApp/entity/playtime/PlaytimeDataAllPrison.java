...
@Entity
@Table(name = "playtime_data_all_prison")
public class PlaytimeDataAllPrison {
    ...
    public PlaytimeDataAllPrison(){}

    public PlaytimeDataAllPrison(Integer id, Integer itsVaidasOn, Integer itsVaidasOff, Integer itsVaidasDiff,
