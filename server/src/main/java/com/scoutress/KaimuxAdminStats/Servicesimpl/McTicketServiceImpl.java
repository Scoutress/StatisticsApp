...
// ProductivityRepository productivityRepository, McTicketPercentageRepository
...
// List<McTicketPercentage> allPercentages =
// mcTicketPercentageRepository.findAll();

// Map<Integer, List<McTicketPercentage>> percentagesPerEmployee =
// allPercentages.stream()
// .collect(Collectors.groupingBy(McTicketPercentage::getEmployeeId));

// for (Map.Entry<Integer, List<McTicketPercentage>> entry :
