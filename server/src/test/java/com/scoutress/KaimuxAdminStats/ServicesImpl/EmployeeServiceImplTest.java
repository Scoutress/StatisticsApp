...
public class EmployeeServiceImplTest {
  ...
  public void testFindAll_ReturnsEmployees() {
    Employee employee1 = new Employee(1, "user1", "Level 1", "English", "John", "Doe", "john.doe@example.com",
        LocalDate.of(2020, 1, 1));
    Employee employee2 = new Employee(2, "user2", "Level 2", "Spanish", "Jane", "Doe", "jane.doe@example.com",
        LocalDate.of(2019, 5, 15));
    when(employeeRepository.findAllByOrderByLevel()).thenReturn(Arrays.asList(employee1, employee2));
  ...
  public void testSave_Employee_Success() {
    Employee employee = new Employee(null, "user1", "Level 1", "English", "John", "Doe", "john.doe@example.com",
        LocalDate.of(2020, 1, 1));
    Employee savedEmployee = new Employee(1, "user1", "Level 1", "English", "John", "Doe", "john.doe@example.com",
        LocalDate.of(2020, 1, 1));
  ...
  public void testSave_ProductivityRepositoryThrowsException() {
    ...
    Employee savedEmployee = new Employee(1, "user1", "Level 1", "English", "John", "Doe", "john.doe@example.com",
        LocalDate.of(2020, 1, 1));
    when(employeeRepository.save(employee)).thenReturn(savedEmployee);
    when(productivityRepository.save(any(Productivity.class))).thenThrow(new RuntimeException("Database error"));
