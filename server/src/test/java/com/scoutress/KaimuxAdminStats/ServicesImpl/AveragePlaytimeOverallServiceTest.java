...
// import
// com.scoutress.KaimuxAdminStats.repositories.playtime.AveragePlaytimeOverallRepository;
// import com.scoutress.KaimuxAdminStats.servicesImpl.DataExtractingServiceImpl;
// import
// com.scoutress.KaimuxAdminStats.servicesImpl.playtime.AveragePlaytimeOverallServiceImpl;
...
// new DailyPlaytime(1L, (short) 1, 120.0, LocalDate.now().minusDays(10),
// "Test"),
// new DailyPlaytime(2L, (short) 1, 180.0, LocalDate.now().minusDays(9),
// "Test"));
// List<EmployeeCodes> employeeAids = Arrays.asList(
// new EmployeeCodes(1L, (short) 1, (short) 1, (short) 1, (short) 1, (short) 1,
// (short) 1, (short) 1,
// (short) 1, (short) 1, (short) 1));
// List<Employee> employees = Arrays.asList(
// new Employee((short) 1, "firstName", "lastName", "email", "phone", "role",
...
// List<AveragePlaytimeOverall> result =
// averagePlaytimeService.calculateAveragePlaytime(playtimes, employeeAids,
// employees);
...
// AveragePlaytimeOverall averagePlaytime = new AveragePlaytimeOverall(1L,
// (short) 1, 150.0);
// List<AveragePlaytimeOverall> averagePlaytimeList =
